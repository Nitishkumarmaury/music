...
const ElectricBorder = ({
  ...
  return (
    ...
    >
      ...
      {showContent && (
        <div className="eb-content relative overflow-hidden">
          <div className="absolute inset-0 w-full h-full z-0 pointer-events-none">
            <Iridescence color={[1,0.9,0.7]} speed={1.2} amplitude={0.18} mouseReact={false} />
          </div>
          {/* Optional: add a semi-transparent overlay for readability */}
          <div className="absolute inset-0 w-full h-full z-10 bg-cream-50/80 pointer-events-none" />
